...
def parse_arguments():
    parser = argparse.ArgumentParser(description="BERT for Entity Extraction")
    parser.add_argument("--bert-repository", type=str, default="dbmdz/bert-base-turkish-cased", help="BERT Repository")
...
def evaluate_model(labels, predictions):
    ...
    plt.savefig("./output/bert_confusion_matrix.png")
...
def main():
    ...
    tokenizer = BertTokenizerFast.from_pretrained(args.bert_repository)
    ...
    model = BertForTokenClassification.from_pretrained(args.bert_repository, num_labels=len(labels_to_ids)).to(device)
