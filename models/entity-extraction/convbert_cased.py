...
def parse_arguments():
    parser = argparse.ArgumentParser(description="ConvBERT for Entity Extraction")
    parser.add_argument("--bert-repository", type=str, default="dbmdz/convbert-base-turkish-cased", help="ConvBERT Repository")
...
def evaluate_model(labels, predictions):
    ...
    plt.title("ConvBERT - Aspect Extraction")
    plt.show()
