...
def main():
    ...
    print(f"Bi-GRU + GloVe Train Time = {model1_train_time:.4f}")
    ...
    print(f"Bi-GRU + GloVe Test Time = {model1_test_time:.4f}")
    ...
    print(f"Bi-GRU + GloVe Train Score = {model_train_score * 100:.4f}%")
    print(f"Bi-GRU + GloVe Test Score = {model_test_score * 100:.4f}%")
    ...
    print(f"Bi-GRU + GloVe Precision Score = {model_precision_score * 100:.4f}%")
    print(f"Bi-GRU + GloVe F1 Score = {model_f1_score * 100:.4f}%")
    print(f"Bi-GRU + GloVe Recall Score = {model_recall_score * 100:.4f}%")
    print(f"Bi-GRU + GloVe Accuracy Score = {model_accuracy_score * 100:.4f}%")
