...
def parse_arguments():
    parser = argparse.ArgumentParser(description="RNN (Two Input) for Entity Extraction")
...
def main():
    ...
    gru1 = layers.SimpleRNN(128)(embedded_sequences1)
    gru2 = layers.SimpleRNN(128)(embedded_sequences2)
    ...
    plt.title("RNN (Two Input) - Sentiment Analysis")
    plt.savefig("./output/rnn_two_input.png")
