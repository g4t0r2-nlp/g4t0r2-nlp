...
def parse_arguments():
    parser = argparse.ArgumentParser(description="LSTM for Entity Extraction")
...
def main():
    ...
    model_precision_score = precision_score(true_labels_test, model_pred_test, average="weighted")
    model_f1_score = f1_score(true_labels_test, model_pred_test, average="weighted")
    model_recall_score = recall_score(true_labels_test, model_pred_test, average="weighted")
