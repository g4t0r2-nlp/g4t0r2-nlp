...
def parse_arguments():
    parser = argparse.ArgumentParser(description="ELECTRA for Entity Extraction")
    parser.add_argument("--bert-repository", type=str, default="dbmdz/electra-small-turkish-cased-discriminator", help="ELECTRA Repository")
