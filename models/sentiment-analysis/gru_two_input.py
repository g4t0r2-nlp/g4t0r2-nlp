...
def parse_arguments():
    parser = argparse.ArgumentParser(description="GRU (Two Input) for Entity Extraction")
...
def main():
    ...
    gru1 = layers.GRU(128)(embedded_sequences1)
    gru2 = layers.GRU(128)(embedded_sequences2)
